...
import 'nome_contorno_model.dart';
export 'nome_contorno_model.dart';
...
class _NomeContornoWidgetState extends State<NomeContornoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NomeContornoModel());
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Text(
                  'Adicione um novo nome ao contorno',
              ...
              child: Row(
                ...
                children: [
                  FFButtonWidget(
                    onPressed: () async {
                      setState(() {
                        FFAppState().updateGrupoContornoFazendasAtIndex(
                          widget.indexinlist!,
                          (_) => functions.editaJson(
                              'nome', _model.textController.text, widget.json)!,
                        );
                      });
                      Navigator.pop(context);
                    },
