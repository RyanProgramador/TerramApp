                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        await showDialog(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return AlertDialog(
                                                                              title: Text('Ops!'),
                                                                              content: Text('Você não tem internet, você poderá usar o serviço de localização, entretanto, nenhuma rota será sugerida no momento.'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext),
                                                                                  child: Text('Ok'),
