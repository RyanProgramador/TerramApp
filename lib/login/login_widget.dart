      ...
      body: Align(
        ...
        child: InkWell(
          ...
          onTap: () async {
            ...
            if ((FFAppState().userLogin != null &&
                    FFAppState().userLogin != '') &&
                (FFAppState().psdwLogin != null &&
                    FFAppState().psdwLogin != '')) {
              _model.loginStatusquandoEntra =
                  await ModuloSeguraGroup.loginsCall.call(
                                                          ...
                                                          if (ModuloSeguraGroup
                                                            ...
                                                            await showDialog(
                                                              ...
                                                              builder:
                                                                  (alertDialogContext) {
                                                                return AlertDialog(
                                                                  content: Text(ModuloSeguraGroup
                                                                      .loginsCall
                                                                      .messageLogin(
                                                                        (_model.loginStatus?.jsonBody ??
                                                                            ''),
